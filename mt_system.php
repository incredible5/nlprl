...
<html>
    ...
    <body>
        ...
        <iframe src="http://nlprl.iitbhu.ac.in/sampark-bmm/" width="100%" height="500em" style="margin-top: 2%">Please upgrade your browser to use the Machine Translation system!</iframe>
        <iframe src="http://nlprl.iitbhu.ac.in/sampark-hpu/" width="100%" height="500em" style="margin-top: 2%"></iframe>
        <iframe src="http://nlprl.iitbhu.ac.in/anusaaraka/" width="100%" height="500em" style="margin-top: 2%"></iframe>
        <br>
        <br>
        <div class="footer">
