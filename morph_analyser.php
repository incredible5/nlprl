...
<html>
    ...
    <body>
        ...
        <iframe src="http://nlprl.iitbhu.ac.in/bmmmorph/" width="100%" height="700em" style="margin-top: 2%">Please upgrade your browser use the morphological analyser!</iframe>
        <br>
        <br>
        <div class="footer">
